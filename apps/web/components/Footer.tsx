        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Features</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Integrations</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Enterprise</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Changelog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Documentation</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Community</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Templates</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Help Center</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Terms of Service</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Security</a></li>
              <li><a href="#" className="hover:text-[#60A5FA] transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
