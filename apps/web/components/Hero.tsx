...
export const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 overflow-hidden bg-gradient-to-br from-[#DBEAFE]/30 via-white to-[#60A5FA]/20">
      {/* Animated Gradient Background Decor */}
      <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 w-[600px] h-[600px] bg-gradient-to-br from-[#60A5FA]/40 via-[#3B82F6]/30 to-[#2563EB]/20 rounded-full blur-3xl -z-10 animate-pulse-slow"></div>
      <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 w-[500px] h-[500px] bg-gradient-to-tr from-[#DBEAFE]/40 via-[#60A5FA]/30 to-[#3B82F6]/20 rounded-full blur-3xl -z-10 animate-float"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,_#3B82F610,_#60A5FA05_40%,_transparent_70%)] rounded-full blur-3xl -z-10"></div>

      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8 text-center lg:text-left">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#DBEAFE] via-white to-[#60A5FA] border border-[#3B82F6]/30 shadow-lg shadow-[#2563EB]/10 text-sm font-medium text-brand-700 animate-fade-in-up backdrop-blur-sm" style={{ animationDelay: '0ms' }}>
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#3B82F6] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-gradient-to-br from-[#60A5FA] to-[#3B82F6]"></span>
            </span>
        ...
        <div className="relative animate-fade-in-up" style={{ animationDelay: '500ms' }}>
          ...
          <div className="absolute -bottom-6 right-8 bg-gradient-to-br from-white via-[#DBEAFE]/50 to-[#60A5FA]/30 p-3 rounded-xl shadow-xl border border-[#3B82F6]/30 flex items-center gap-3 animate-float backdrop-blur-sm" style={{ animationDelay: '1.5s' }}>
             <div className="p-2 bg-gradient-to-br from-[#60A5FA] to-[#3B82F6] text-white rounded-lg shadow-md">
                <Zap size={20} fill="currentColor" />
             </div>
             <div>
                <div className="text-xs text-stone-500 font-medium">Performance</div>
                <div className="text-sm font-bold bg-gradient-to-r from-[#60A5FA] to-[#3B82F6] bg-clip-text text-transparent">60 FPS</div>
             </div>
          </div>
        </div>
      </div>
